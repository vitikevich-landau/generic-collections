...
// память вовсе, а Map и Filter делают не более одной собственной аллокации
// под результат (не считая того, что выделяют переданные им функции).
//
...
//
// Гарантия распространяется только на собственную память функций. Callback'и
// ниже специально не аллоцируют: аллоцирующий f добавил бы по аллокации на
// каждый элемент, и измерять инвариант самих Map и Filter стало бы нечем.
//
